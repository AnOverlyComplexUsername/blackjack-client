...
public class BlackjackClient {
    ...
    private static final String USERNAME = "vtang"; // replace with your username
    private static final String PASSWORD = "3fe1c42"; // replace with your from the file posted to Classroom
